        ...
        <div class="header-inner flex items-center justify-between lg:justify-start">
            ...
            <div class="header-menu grow hidden lg:flex items-center ml-8 gap-8">
                <form action="{{ route('catalog') }}" class="hidden lg:flex ml-24 gap-4 w-2/5">
                    ...
                    <button type="submit" class="shrink-0 w-12 !h-12 !px-0 btn btn-blue">
            ...
            <div class="header-actions flex items-center gap-3 md:gap-5">
                @auth
                    <div x-data="{ dropdownProfile: false }" class="profile relative">
                        ...
                        <div x-show="dropdownProfile" @click.away="dropdownProfile = false" x-cloak
                            ...
                            class="absolute z-50 top-0 right-10 xs:-right-10 sm:-right-36 w-[280px] sm:w-[300px] mt-14 p-4 rounded-lg shadow-xl bg-card">
                ...
                <a href="{{ route('cart') }}" class="flex items-center gap-3 text-darkblue hover:text-gray">
                    ...
                    <div class="hidden sm:flex flex-col gap-2">
                        <span class="text-gray-800 text-xxs !leading-none">
                            {{ cart()->count() }} шт.
                        </span>
                        <span class="text-black text-xxs 2xl:text-xs font-bold !leading-none">
                            {{ cart()->total() }}
                        </span>
                    </div>
                </a>

                <button id="burgerMenu" class="flex lg:hidden text-darkblue hover:text-blue-600 transition">
                ...
                @guest
                    <a href="{{ route('login') }}" class="profile hidden xs:flex items-center">
                        <svg class="profile-icon w-8 h-8 text-darkblue" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <span class="profile-text relative ml-2 text-black text-xxs md:text-xs font-bold">Войти</span>
                    </a>
                @endguest
