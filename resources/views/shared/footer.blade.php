<footer class="footer py-8 bg-bgheader">
    <div class="container">
        <div class="flex flex-wrap lg:flex-nowrap items-center">
            <!-- /.footer-logo -->
            <div class="footer-logo order-0 basis-full sm:basis-1/2 lg:basis-1/3 shrink-0 text-center sm:text-left">
                <a href="{{ route('home') }}" class="inline-block mt-1" rel="home">
                    <img src="{{ Vite::image('logo.svg') }}" class="w-[38px] h-[38px]" alt="CutCode">
                </a>
            </div>
            ...
            <div class="footer-social order-1 lg:order-2 basis-full sm:basis-1/2 lg:basis-1/3 mt-8 sm:mt-0">
                <div class="flex flex-wrap items-center justify-center sm:justify-end space-x-6">
                    <a href="https://youtube.com" class="inline-flex items-center text-darkblue hover:text-purple"
                    ...
                    <a href="https://telegram.org" class="inline-flex items-center text-darkblue hover:text-purple"
                        target="_blank" rel="nofollow noopener">
        ...
        <div class="mmenu-inner pt-10">
            ...
            @auth
                <div class="flex items-center">
                    <img src="{{ Vite::image('avatar.jpg') }}" class="w-14 h-14 rounded-full"
                        alt="{{ auth()->user()?->name }}">
            ...
            <nav class="flex flex-col mt-8">
                <a href="{{ route('home') }}" class="self-start py-1 text-dark hover:text-pink text-md font-bold">
                    Главная
                </a>
                <a href="{{ route('catalog') }}" class="self-start py-1 text-dark hover:text-pink text-md font-bold">
                    Каталог товаров
                </a>
                @auth
                    <a href="#" class="self-start py-1 text-dark hover:text-pink text-md font-bold">
                        Мои заказы
                    </a>
                @endauth
                <a href="{{ route('cart') }}" class="self-start py-1 text-dark hover:text-pink text-md font-bold">
                    Корзина
                </a>
            </nav>
