<ul class="space-y-3 my-2">
    <li>
        <a href="{{ route('socialRedirect', ['socialName' => 'github']) }}"
            class="relative flex items-center h-14 px-12 rounded-lg border border-black bg-white/20 hover:bg-white/20 active:bg-white/10 active:translate-y-0.5">
            <svg class="shrink-0 absolute left-4 w-5 sm:w-6 h-5 sm:h-6 text-black" xmlns="http://www.w3.org/2000/svg"
            ...
            <span class="grow text-xxs md:text-xs font-bold text-center text-black">GitHub</span>
        </a>
    </li>
    <li>
        <a href="{{ route('socialRedirect', ['socialName' => 'google']) }}"
            class="relative flex items-center h-14 px-12 rounded-lg border border-black bg-white/20 hover:bg-white/20 active:bg-white/10 active:translate-y-0.5">
            <svg class="shrink-0 absolute left-4 w-5 sm:w-6 h-5 sm:h-6 text-black" fill="currentColor"
            ...
            <span class="grow text-xxs md:text-xs font-bold text-center text-black">Google</span>
        </a>
    </li>
</ul>
